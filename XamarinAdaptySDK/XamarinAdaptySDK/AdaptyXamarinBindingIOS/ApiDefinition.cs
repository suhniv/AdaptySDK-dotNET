...
namespace AdaptyBinding
{
	...
	interface AccessLevelInfoModel : INativeObject
	{
		...
		[Export("id")] string Id { get; set; }

		// @property (nonatomic) BOOL isActive;
		[Export("isActive")] bool IsActive { get; set; }

		// @property (copy, nonatomic) NSString * _Nonnull vendorProductId;
		[Export("vendorProductId")] string VendorProductId { get; set; }

		// @property (copy, nonatomic) NSString * _Nonnull store;
		[Export("store")] string Store { get; set; }
		...
		[Export("isLifetime")] bool IsLifetime { get; set; }
		...
		[Export("willRenew")] bool WillRenew { get; set; }

		// @property (nonatomic) BOOL isInGracePeriod;
		[Export("isInGracePeriod")] bool IsInGracePeriod { get; set; }
		...
		[Export("isRefund")] bool IsRefund { get; set; }
	...
	interface Adapty
	{
		...
		void UpdateAttribution(NSDictionary attribution, AttributionNetwork source, [NullAllowed] string networkUserId,
			[NullAllowed] Action<AdaptyError> completion);
		...
		void GetPaywallsWithForceUpdate(bool forceUpdate,
			Action<NSArray<PaywallModel>, NSArray<ProductModel>, AdaptyError> completion);
		...
		void MakePurchaseWithProduct(ProductModel product, [NullAllowed] string offerId,
			Action<PurchaserInfoModel, NSString, NSDictionary<NSString, NSObject>, ProductModel, AdaptyError>
				completion);
		...
		void RestorePurchasesWithCompletion(
			Action<PurchaserInfoModel, NSString, NSDictionary<NSString, NSObject>, AdaptyError> completion);

		// +(void)validateReceipt:(NSString * _Nonnull)receiptEncoded completion:(void (^ _Nonnull)(PurchaserInfoModel * _Nullable, NSDictionary<NSString *,id> * _Nullable, AdaptyError * _Nullable))completion;
		[Static]
		[Export("validateReceipt:completion:")]
		void ValidateReceipt(string receiptEncoded,
			Action<PurchaserInfoModel, NSDictionary<NSString, NSObject>, AdaptyError> completion);
		...
		// +(PaywallViewController * _Nonnull)showPaywallFor:(PaywallModel * _Nonnull)paywall from:(UIViewController * _Nonnull)viewController delegate:(id<AdaptyPaywallDelegate> _Nonnull)delegate;
		// [Static]
		// [Export("showPaywallFor:from:delegate:")]
		// PaywallViewController ShowPaywallFor(PaywallModel paywall, UIViewController viewController,
		// 	AdaptyPaywallDelegate @delegate);

		// +(PaywallViewController * _Nonnull)getPaywallFor:(PaywallModel * _Nonnull)paywall delegate:(id<AdaptyPaywallDelegate> _Nonnull)delegate __attribute__((warn_unused_result("")));
		// [Static]
		// [Static]
		// [Export("getPaywallFor:delegate:")]
		// PaywallViewController GetPaywallFor(PaywallModel paywall, AdaptyPaywallDelegate @delegate);
	...
	interface AdaptyDelegate
	{
		...
		void PaymentQueueWithShouldAddStorePaymentFor(ProductModel product,
			NestedCallbackDelegate makeDeferredPurchase);
	}
	...
	// @protocol AdaptyPaywallDelegate
	[Protocol(Name = "_TtP6Adapty21AdaptyPaywallDelegate_"), Model(AutoGeneratedName = true)]
	interface AdaptyPaywallDelegate
	{
		// @required -(void)didPurchaseWithProduct:(ProductModel * _Nonnull)product purchaserInfo:(PurchaserInfoModel * _Nullable)purchaserInfo receipt:(NSString * _Nullable)receipt appleValidationResult:(NSDictionary<NSString *,id> * _Nullable)appleValidationResult paywall:(PaywallViewController * _Nonnull)paywall;
		[Abstract]
		[Export("didPurchaseWithProduct:purchaserInfo:receipt:appleValidationResult:paywall:")]
		void DidPurchaseWithProduct(ProductModel product, [NullAllowed] PurchaserInfoModel purchaserInfo,
			[NullAllowed] string receipt, [NullAllowed] NSDictionary<NSString, NSObject> appleValidationResult,
			PaywallViewController paywall);

		// @required -(void)didFailPurchaseWithProduct:(ProductModel * _Nonnull)product error:(AdaptyError * _Nonnull)error paywall:(PaywallViewController * _Nonnull)paywall;
		[Abstract]
		[Export("didFailPurchaseWithProduct:error:paywall:")]
		void DidFailPurchaseWithProduct(ProductModel product, AdaptyError error, PaywallViewController paywall);

		// @required -(void)didCloseWithPaywall:(PaywallViewController * _Nonnull)paywall;
		[Abstract]
		[Export("didCloseWithPaywall:")]
		void DidCloseWithPaywall(PaywallViewController paywall);
	}
	...
	interface NonSubscriptionInfoModel : INativeObject
	{
		...
		[Export("purchaseId")] string PurchaseId { get; set; }
		...
		[Export("isOneTime")] bool IsOneTime { get; set; }

		// @property (nonatomic) BOOL isSandbox;
		[Export("isSandbox")] bool IsSandbox { get; set; }
	...
	interface PaywallModel : INativeObject
	{
		...
		[Export("developerId")] string DeveloperId { get; set; }

		// @property (copy, nonatomic) NSString * _Nonnull variationId;
		[Export("variationId")] string VariationId { get; set; }

		// @property (nonatomic) NSInteger revision;
		[Export("revision")] nint Revision { get; set; }

		// @property (nonatomic) BOOL isPromo;
		[Export("isPromo")] bool IsPromo { get; set; }
		...
		[NullAllowed, Export("visualPaywall")] string VisualPaywall { get; set; }
	...
	[BaseType(typeof(UIViewController), Name = "_TtC6Adapty21PaywallViewController")]
	...
	interface ProductDiscountModel
	{
		...
		[NullAllowed, Export("identifier")] string Identifier { get; set; }
		...
		[Export("numberOfPeriods")] nint NumberOfPeriods { get; set; }
	...
	interface ProductModel : INativeObject
	{
		...
		[Export("localizedDescription")] string LocalizedDescription { get; set; }

		// @property (copy, nonatomic) NSString * _Nonnull localizedTitle;
		[Export("localizedTitle")] string LocalizedTitle { get; set; }
		...
		[NullAllowed, Export("currencyCode")] string CurrencyCode { get; set; }
		...
		[NullAllowed, Export("regionCode")] string RegionCode { get; set; }
	...
	interface ProductSubscriptionPeriodModel
	{
		...
		[Export("numberOfUnits")] nint NumberOfUnits { get; set; }
	...
	interface ProfileParameterBuilder
	{
		...
		// -(instancetype _Nonnull)withAppTrackingTransparencyStatus:(NSUInteger)appTrackingTransparencyStatus __attribute__((warn_unused_result("")));
		[Export("withAppTrackingTransparencyStatus:")]
		ProfileParameterBuilder WithAppTrackingTransparencyStatus(nuint appTrackingTransparencyStatus);
	}
	...
	interface PromoModel
	{
		...
		[Export("promoType")] string PromoType { get; set; }
	...
	interface PurchaserInfoModel
	{
		...
		NSDictionary AccessLevels { get; set; }
		...
		NSDictionary Subscriptions { get; set; }
		...
		NSDictionary NonSubscriptions { get; set; }
