...
+ (PaywallViewController * _Nonnull)getPaywallFor:(PaywallModel * _Nonnull)paywall delegate:(id <AdaptyPaywallDelegate> _Nonnull)delegate SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_PROTOCOL("_TtP6Adapty21AdaptyPaywallDelegate_")
@protocol AdaptyPaywallDelegate
...
- (void)didCloseWithPaywall:(PaywallViewController * _Nonnull)paywall;
@end
...
- (nonnull instancetype)withAppTrackingTransparencyStatus:(NSUInteger)appTrackingTransparencyStatus SWIFT_WARN_UNUSED_RESULT;
