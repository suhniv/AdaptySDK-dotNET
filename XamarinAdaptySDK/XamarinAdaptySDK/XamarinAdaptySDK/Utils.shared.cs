    ...
    public static partial class Utils
    {
        ...
        static Utils()
        {
            CurrencyMap = CultureInfo
                ...
                .ToDictionary(x => x.Key.ToLower(), x => x.FirstOrDefault()!.CurrencySymbol);
        }
        ...
        public static TimeSpan Iso8601ToTimeSpan(this string isoString) =>
            string.IsNullOrEmpty(isoString) ? TimeSpan.Zero : XmlConvert.ToTimeSpan(isoString);
    }
}